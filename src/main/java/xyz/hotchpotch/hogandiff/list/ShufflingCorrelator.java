...
/*package*/ class ShufflingCorrelator<T> implements Correlator<T> {
    ...
    private static class Cost implements Comparable<Cost> {
        ...
        /** 比較対象リストAにおける比較対象要素1のインデックス（欠損の場合はnull） */
        private final Integer idxA;
        
        /** 比較対象リストBにおける比較対象要素2のインデックス（欠損の場合はnull） */
         ...
         *   <li>双方ともにペアリング済みでここまでで大小が決まらない場合は、idx1 の小さい方を「小さい」と判断</li>
         *   <li>双方ともに単独で要素1の有無が異なる場合は、要素1の存在する方を「小さい」と判断</li>
