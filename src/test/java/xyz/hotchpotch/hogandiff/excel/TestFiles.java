...
public class TestFiles {
    ...
    public static final File SheetLister1_normal_xlsx = new File(TestFiles.class.getResource(
            "TestSheetLister1_normal.xlsx").getFile());
    
    public static final File SheetLister1_normal_xlsm = new File(TestFiles.class.getResource(
            "TestSheetLister1_normal.xlsm").getFile());
    
    public static final File SheetLister1_normal_xlsb = new File(TestFiles.class.getResource(
            "TestSheetLister1_normal.xlsb").getFile());
    
    public static final File SheetLister1_normal_xls = new File(TestFiles.class.getResource(
            "TestSheetLister1_normal.xls").getFile());
    
    public static final File SheetLister1_normal_csv = new File(TestFiles.class.getResource(
            "TestSheetLister1_normal.csv").getFile());
    
    public static final File SheetLister1_normal = new File(TestFiles.class.getResource(
            "TestSheetLister1_normal").getFile());
    
    public static final File SheetLister2_namevariations_xlsx = new File(TestFiles.class.getResource(
            "TestSheetLister2_namevariations.xlsx").getFile());
    
    public static final File SheetLister2_namevariations_xlsm = new File(TestFiles.class.getResource(
            "TestSheetLister2_namevariations.xlsm").getFile());
    
    public static final File SheetLister2_namevariations_xlsb = new File(TestFiles.class.getResource(
            "TestSheetLister2_namevariations.xlsb").getFile());
    
    public static final File SheetLister2_namevariations_xls = new File(TestFiles.class.getResource(
            "TestSheetLister2_namevariations.xls").getFile());
    
    public static final File SheetLister3_dummy_xlsx = new File(TestFiles.class.getResource(
            "TestSheetLister3_dummy.xlsx").getFile());
    
    public static final File SheetLister3_dummy_xls = new File(TestFiles.class.getResource(
    ...
    public static final File SheetLoader1_normal_xlsx = new File(TestFiles.class.getResource(
            "TestSheetLoader1_normal.xlsx").getFile());
    
    public static final File SheetLoader1_normal_xlsm = new File(TestFiles.class.getResource(
            "TestSheetLoader1_normal.xlsm").getFile());
    
    public static final File SheetLoader1_normal_xlsb = new File(TestFiles.class.getResource(
            "TestSheetLoader1_normal.xlsb").getFile());
    
    public static final File SheetLoader1_normal_xls = new File(TestFiles.class.getResource(
            "TestSheetLoader1_normal.xls").getFile());
    
    public static final File SheetLoader1_normal_csv = new File(TestFiles.class.getResource(
            "TestSheetLoader1_normal.csv").getFile());
    
    public static final File SheetLoader1_normal = new File(TestFiles.class.getResource(
